...
import { getAllDisinfectors, addMaterialToDisinfector } from '../../actions/adminActions';
...
export default connect(mapStateToProps, { getAllDisinfectors, addMaterialToDisinfector })(withRouter(AdminMaterials));